...
//==== desplagar catalogo
const abrirCat = document.getElementById('abrirCat')
const cerrarCat = document.getElementById('cerrarCat')
const mostrarCatalogo = document.getElementsByClassName('mostrarCatalogo')[0]

abrirCat.addEventListener('click', () => {
    mostrarCatalogo.classList.add('catalogoActive')
})

cerrarCat.addEventListener('click', () => {
    mostrarCatalogo.classList.remove('catalogoActive')
})
